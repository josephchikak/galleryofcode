...
export default function Nav() {
  return (
    <nav className="fixed inset-x-0 top-0 z-40 flex items-center justify-center px-6 py-5 md:px-10">
      {/* <a href="#top" className="font-heading text-sm font-bold tracking-widest">
        GALLERY OF CODE<span className="text-primary">_</span>
      </a> */}
<div className="flex gap-6 font-heading text-xs tracking-wider">
